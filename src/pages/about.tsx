...
export default function about() {
  return (
    <div className='fixed bottom-0 left-0 p-[2rem] uppercase sm:top-[9%] sm:left-[50%]'>
      <div className='flex flex-col gap-[2rem] sm:flex-row'>
        <div className='w-full max-w-[300px]'>
            <p>Marlon Martin is an information technology student based in Manila, Philippines. Currently into <span className='font-bold'>Competitive programming</span> and <span className='font-bold'>Software Engineering</span>.</p>
        </div>
